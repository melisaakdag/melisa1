    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (label2.Text == "-1")
            {
                ...
                label3.Text = "00";
                //show message
                MessageBox.Show("programlama dogru s�nav� sayisi", dogru.ToString());
                MessageBox.Show("programlama s�nav� yanl�� sayisi", yanlis.ToString());
                MessageBox.Show(" donan�m yanlis sayisi", yanlis2.ToString());
                MessageBox.Show(" donan�m dogru sayisi", dogru2.ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("yanl�� sayisi", yanlis.ToString());
        }
